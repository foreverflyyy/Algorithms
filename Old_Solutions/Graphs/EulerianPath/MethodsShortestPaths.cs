...
namespace Graphs
{
    public class MethodsShortestPaths<T>
    {
        ...
        /// <summary>
        /// Эйлеров цикл 
        /// (ДОРЕАЛИЗОВАТЬ ПОПЫТКУ ДОБАВЛЕНИЯ В СЛОВАРЬ ПО ЕЩЁ ОДНОМУ КЛЮЧУ)
        /// </summary>
        public void EulerianPath()
        {
            ...
            {
                // ЕСЛИ СУЩЕСТВУЕТ ЛИШЬ ЭЙЛЕРОВ ПУТЬ И МЕЖДУ ДВУМЯ НЕЧЁТНЫМИ ВЕРШИНАМИ УЖЕ ЕСТЬ ПУТЬ, ТО
                // ВЫДАСТ ОШИБКУ, Т.К В СЛОВАРЬ НЕЛЬЗЯ ДОБАВИТЬ ВТОРОЙ ТАКОЙ ЖЕ КЛЮЧ
